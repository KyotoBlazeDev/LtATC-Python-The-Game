...
def show_warning(message: str, parent=None) -> None:
    messagebox.showwarning("Safety validation", message, parent=parent)

def show_report(lesson, metrics, player_name="Controller", parent=None) -> None:
    ...
    messagebox.showinfo("Lesson report", f"LESSON COMPLETE\n{player_name} — {lesson.title}\n\n"
                        ...
                        "Blaze: Good. You checked the situation before transmitting.", parent=parent)
